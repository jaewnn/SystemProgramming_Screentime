...
screen_time: screen_time.o screen_time_func.o usage_time.o hashmap.o
	gcc -o screen_time obj/screen_time.o obj/screen_time_func.o obj/usage_time.o obj/hashmap.o -lrt -lcurses
...
screen_time_func.o: src/screen_time_func.c src/usage_time.h
