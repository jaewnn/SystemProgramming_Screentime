...
int main(int argc, char* argv[])
{
    ...
    while(head)
    {
        ...
        printf("%6ld %20s %3lld %3lld %7lld %6lld %6lld %3c %3.1f %3.1f %10lld %20s\n", head->pid, head->user_name, head->priority, head->nice, head->virt, head->res,
